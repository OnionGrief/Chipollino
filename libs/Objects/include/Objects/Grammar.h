...
class Grammar {
  ...
  public:
	...
	static void update_classes(set<int>& checker,		// NOLINT(runtime/references)
	...
	static void check_classes(vector<vector<vector<GrammarItem*>>>& rules,		// NOLINT(runtime/references)
							  map<set<string>, vector<GrammarItem*>>& classes_check_map,		// NOLINT(runtime/references)
	...
	static vector<vector<vector<GrammarItem*>>> get_bisimilar_grammar(
		vector<vector<vector<GrammarItem*>>>& rules, vector<GrammarItem*>& nonterminals,		// NOLINT(runtime/references)
	...
	static vector<vector<vector<GrammarItem*>>> fa_to_grammar(const vector<State>& states,
	...
	static vector<vector<vector<GrammarItem*>>> tansitions_to_grammar(
		...
		vector<GrammarItem*>& nonterminals, vector<GrammarItem*>& terminals);		// NOLINT(runtime/references)
