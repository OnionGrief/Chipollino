...
public:
	...
	static void log(string r1, string r2, int step, vector<double> times, vector<bool> booleans);
	static void log(const FiniteAutomaton& fa1, string r2, int step, vector<double> times, vector<bool> booleans);
	// завершение шага
